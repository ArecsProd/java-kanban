...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        taskManager.addTask("Задача 1", "Выполнить задачу 1", Statuses.NEW);
        System.out.println("Создаём задачу \"Задача 2\"");
        taskManager.addTask("Задача 2", "Выполнить задачу 2", Statuses.DONE);
        System.out.println("Создаём задачу \"Задача 3\"\n\n");
        taskManager.addTask("Задача 3", "Выполнить задачу 3", Statuses.IN_PROGRESS);

        System.out.println("Пытаемся добавить подзадачу при отсутствии эпиков");
        taskManager.addSubtask("Подзадача 1.3", "Это 1.3", "Эпик 1", Statuses.IN_PROGRESS);
        ...
        taskManager.addSubtask("Подзадача 1.1", "Это 1.1", "Эпик 1", Statuses.NEW);
        System.out.println("Создаём подзадачу для Эпик 1 \"Подзадача 1.2\"");
        taskManager.addSubtask("Подзадача 1.2", "Это 1.2", 4, Statuses.DONE);
        System.out.println("Создаём подзадачу для Эпик 1 \"Подзадача 1.3\"");
        taskManager.addSubtask("Подзадача 1.3", "Это 1.3", 4, Statuses.IN_PROGRESS);

        System.out.println("Создаём подзадачу для Эпик 2 \"Подзадача 2.1\"");
        taskManager.addSubtask("Подзадача 2.1", "Это 2.1", "Эпик 2", Statuses.DONE);
        System.out.println("Создаём подзадачу для Эпик 2 \"Подзадача 2.2\"");
        taskManager.addSubtask("Подзадача 2.2", "Это 2.2", "Эпик 2", Statuses.DONE);

        System.out.println("Создаём подзадачу для Эпик 3 \"Подзадача 3.1\"");
        taskManager.addSubtask("Подзадача 3.1", "Это 3.1", 6, Statuses.DONE);
        ...
        System.out.println("\nОбновляем Задачу 1");
        taskManager.updateTask("Всё ещё задача 1", "Новое описание Задачи 1", Statuses.IN_PROGRESS,
                1);
        System.out.println("Cписок задач - ");
        for (Task task : taskManager.getTaskList()) {
            System.out.println(taskManager.getTask(task));
        ...
        taskManager.updateTask("Задача 1 - *3", "Новейшее описание Задачи 1", Statuses.DONE,
                "Всё ещё задача 1");
        System.out.println("Cписок задач - ");
        for (Task task : taskManager.getTaskList()) {
            System.out.println(taskManager.getTask(task));
        ...
        taskManager.updateSubtask("Подзадача 1.2.2", "Это вторая версия подзадачи 1.2", Statuses.DONE,
                8);
        System.out.println("Cписок подзадач Эпика 1 - " + taskManager.getSubtaskByEpic("Суперновый эпик 1"));

        System.out.println("\nОбновляем подзадачу 1.3");
        taskManager.updateSubtask("Подзадача 1.3.2", "Это вторая версия подзадачи 1.3", Statuses.DONE,
                "Подзадача 1.3");
        ...
        taskManager.addTask("", "", Statuses.NEW);
        System.out.println("Already exist name");
        taskManager.addTask("Задача 1 - *3", "", Statuses.DONE);
        System.out.println("Delete by not found ID");
        taskManager.deleteTask(2);
        System.out.println("Update by not found name");
        taskManager.updateTask("Task 1", " LoL", Statuses.IN_PROGRESS, "Task 1");
        System.out.println("\nCписок задач - ");
        for (Task task : taskManager.getTaskList()) {
            System.out.println(taskManager.getTask(task));
        }
        ...
        taskManager.addSubtask("Subtask 1", "new subtask", 1, Statuses.DONE);
    }
}
